...
class ArterialPool: Metabolizer{
	...
	var	effluentOxygenContent = 19.5328
	var	effluentCO2Content = 47.4132
	var	nitrogenContent = 0.73
	var	effluentNitrogenContent = 0.7257
	var	amountOfN2 = 7.2573
	var	lactateConcentration = 0.9940
